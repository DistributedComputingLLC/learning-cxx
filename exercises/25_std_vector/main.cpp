...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        {
            vec.shrink_to_fit(); // size no change, capacity -> size 
            ASSERT(vec.capacity() == 5, "Fill in the correct value.");
            vec.clear(); // size = 0, capacity no change
    ...
    }
    {
        ...
        {
            vec.reserve(256); // size no change, capacity >= n
            ASSERT(vec.size() == 16, "Fill in the correct value.");
